  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#fcfdff] flex flex-col items-center justify-center gap-6">
        ...
        <p className="text-gray-400 font-black uppercase tracking-widest text-sm">Generating Gartner Prism...</p>
      </div>
    );
  }
    ...
    <div className="p-10 space-y-10 bg-[#fcfdff] min-h-screen">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black text-gray-900 tracking-tight">Gartner Strategic Prism</h1>
