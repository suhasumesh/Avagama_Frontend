    ...
    <div className="bg-avagama-gradient min-h-screen">
      <section className="max-w-7xl mx-auto px-6 pt-20 pb-32 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-8">
          <h1 className="text-7xl font-black leading-[1.1] text-gray-900 tracking-tighter">
          ...
          <div className="space-y-5 pt-4">
            <div className="flex items-center gap-4">
              <div className="bg-[#a26da8] p-2.5 rounded-xl text-white shadow-lg shadow-purple-100">
              ...
              <span className="text-gray-700 font-bold text-sm">AI-Powered process evaluation</span>
            </div>
            <div className="flex items-center gap-4">
              <div className="bg-[#a26da8] p-2.5 rounded-xl text-white shadow-lg shadow-purple-100">
              ...
              <span className="text-gray-700 font-bold text-sm">Automation & augmentation readiness scoring</span>
            </div>
          </div>
          <div className="pt-8">
            <Link to="/register" className="bg-[#a26da8] text-white px-10 py-5 rounded-2xl text-lg font-black hover:bg-[#8b5a93] shadow-2xl shadow-purple-200 transition-all inline-block hover:-translate-y-1 uppercase tracking-widest text-sm">
              Build your roadmap
            </Link>
          </div>
        </div>
