      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        <div className="space-y-10">
          ...
          <div className="flex gap-6 pt-6">
            <a href="https://www.linkedin.com/in/srividyakannan/" target="_blank" rel="noopener noreferrer" className="bg-[#0077b5] text-white px-8 py-4 rounded-2xl flex items-center gap-3 hover:shadow-lg hover:shadow-blue-200 transition-all font-bold">
